...
<body>
		...
		<div class="agileinfo-dot">
			...
			<div class="wthree-heading">
				<h2 style="color:#24F479" >Change Password</h2>
			</div>
		</div>
	</div>
					...
					<div class="agileinfo-contact-form-grid">
						<form method="post" onsubmit="return checkpass();" name="changepassword">
							 <div class="form-group row">
                                    <label class="col-form-label col-md-4" style="color:#e6e6e6;">Current Password</label>
                                    <div  class="col-md-10">
                                        <input type="password" class="form-control" style="font-size: 20px" required="true" name="currentpassword">
                                    </div>
                                </div>
                                                <div class="form-group row">
                                    <label class="col-form-label col-md-4" style="color:#e6e6e6;">New Password</label>
                                    <div class="col-md-10">
                                        <input type="password" class="form-control"  required="true" name="newpassword" style="font-size: 20px">
                                    </div>
                                </div>
                                                 <div class="form-group row">
                                    <label class="col-form-label col-md-4" style="color:#e6e6e6;">Confirm Password</label>
                                    <div class="col-md-10">
