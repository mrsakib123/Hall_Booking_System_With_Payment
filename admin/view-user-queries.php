...
<td colspan="4" style="font-size:20px;color:blue">
 View Queries</td></tr>
    ...
    <tr>
    <th scope style="font-size:14px;">Name</th>
    <td style="font-size:13px;"><?php  echo ($row->Name);?></td>
    
  </tr>
  <tr>
    <th scope style="font-size:14px;">Email</th>
    <td style="font-size:13px;"><?php  echo ($row->Email);?></td>
    
  </tr>
  <tr><th style="font-size:14px;" >Message</th>
    <td colspan="3" style="font-size:13px;"><?php  echo ($row->Message);?></td></tr>
...
<br><br>
<Center >
<a class="liay" style="font-size:18px;" href="mailto:<?php  echo htmlentities($row->Email);?>" target="_blank"> 
										Reply Now</a>
										</center>
                        </div>
                    </div>
