                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">OCBS</span>|<span class="font-size-xl text-primary">Admin</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-puzzle"></i><span class="sidebar-mini-hide"></span>Offers</a>
                                    <ul>
                                        <li>
                                            <a href="add-services.php">Add New Offers</a>
                                        </li>
                                        <li>
                                            <a href="manage-services.php">Manage Offers</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a  href="between-dates-report.php"><i class="si si-vector"></i><span class="sidebar-mini-hide">Between Dates Report</span></a>
